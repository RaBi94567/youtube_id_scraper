...
class YouTubeIDScraper {
  ...
  /// The URL of the YouTube video provided bu user or programmer.
  String? id;

  /// The extracted ID of the YouTube video.
  String? errorLog;

  /// A log to store errors encountered during the extraction process.
  String? errorDescription;

  /// A description of any errors encountered during the extraction process.
  String? urlType;

  /// The type of URL extracted, whether it's a full YouTube URL, a shortened URL, or a YouTube shorts URL.
    ...
    try {
      ...
      if (url.isNotEmpty) {
        if (url.contains("https:///") || url.contains("http:///")) {
          ...
          errorLog = "Invalid URL";
          errorDescription =
              "Provided URL should contain http:/// or https:///";
          urlType = null;
        }
      } else {
